...
var _user$project$Connect4$radio = F2(
	function (msg, name) {
		return A2(
...
var _user$project$Connect4$boardStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Connect4$lth = F2(
	function (n, l) {
		lth:
		while (true) {
			var _p0 = l;
...
var _user$project$Connect4$nth = F2(
	function (n, l) {
		nth:
		while (true) {
			var _p1 = l;
...
var _user$project$Connect4$transpose = function (b) {
	var len = _elm_lang$core$List$length(
		A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
	...
	var build = F2(
		function (n, l) {
			...
			if (_p2.ctor === '[]') {
				...
				return {
					ctor: '::',
					_0: A2(_user$project$Connect4$nth, n, _p2._0),
					_1: A2(build, n, _p2._1)
				};
			}
		});
	var rec = function (n) {
		return (_elm_lang$core$Native_Utils.cmp(n, len) > -1) ? {ctor: '[]'} : {
			ctor: '::',
			_0: A2(build, n, b),
			_1: rec(n + 1)
		};
...
var _user$project$Connect4$colDiags = function (b) {
	var columns = _elm_lang$core$List$length(b);
	var getCell = F2(
		function (x, y) {
			return (_elm_lang$core$Native_Utils.cmp(x, 0) < 0) ? {ctor: '[]'} : {
				ctor: '::',
				_0: A2(
					_user$project$Connect4$nth,
					y,
					A2(_user$project$Connect4$lth, x, b)),
				_1: A2(getCell, x - 1, y + 1)
			};
		});
	var getCols = function (x) {
		return _elm_lang$core$Native_Utils.eq(x, 0) ? {ctor: '[]'} : {
			ctor: '::',
			_0: A2(getCell, x - 1, 0),
			_1: getCols(x - 1)
		};
	};
	return getCols(columns);
};
var _user$project$Connect4$rowDiags = function (b) {
	var columns = _elm_lang$core$List$length(b);
	...
	var getCell = F2(
		function (x, y) {
			return _elm_lang$core$Native_Utils.eq(y, rows) ? {ctor: '[]'} : {
				ctor: '::',
				_0: A2(
					_user$project$Connect4$nth,
					y,
	...
	var getRows = function (y) {
		return _elm_lang$core$Native_Utils.eq(y, 0) ? {ctor: '[]'} : {
			ctor: '::',
			_0: A2(getCell, columns - 1, y),
			_1: getRows(y - 1)
		};
	};
	return getRows(rows - 1);
};
var _user$project$Connect4$diags = function (b) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Connect4$colDiags(b),
		_user$project$Connect4$rowDiags(b));
};
var _user$project$Connect4$listSubs = F2(
	function (n, l) {
		var build = function (l) {
			...
			if (_p3.ctor === '[]') {
				...
				var s = A2(_elm_lang$core$List$take, n, l);
				return (_elm_lang$core$Native_Utils.cmp(
...
var _user$project$Connect4$fourInRow = function (r) {
	var seriesOf = function (v) {
		return A2(
			_elm_lang$core$List$any,
			function (x) {
				return x;
			...
			A2(
				...
				_elm_lang$core$List$all(
					function (x) {
						return _elm_lang$core$Native_Utils.eq(x, v);
					}),
				A2(_user$project$Connect4$listSubs, 4, r)));
	};
	return seriesOf(1) ? 1 : (seriesOf(2) ? 2 : 0);
};
var _user$project$Connect4$winner = function (board) {
	var rows = A3(
		_elm_lang$core$List$foldr,
		_elm_lang$core$Basics$max,
		0,
		A2(_elm_lang$core$List$map, _user$project$Connect4$fourInRow, board));
	var columns = A3(
		_elm_lang$core$List$foldr,
		_elm_lang$core$Basics$max,
		0,
		A2(
			_elm_lang$core$List$map,
			_user$project$Connect4$fourInRow,
			_user$project$Connect4$transpose(board)));
	var diagsUp = A3(
		_elm_lang$core$List$foldr,
		_elm_lang$core$Basics$max,
		0,
		A2(
			_elm_lang$core$List$map,
			_user$project$Connect4$fourInRow,
			_user$project$Connect4$diags(board)));
	var diagsDown = A3(
		_elm_lang$core$List$foldr,
		_elm_lang$core$Basics$max,
		0,
		A2(
			_elm_lang$core$List$map,
			_user$project$Connect4$fourInRow,
			_user$project$Connect4$diags(
				A2(_elm_lang$core$List$map, _elm_lang$core$List$reverse, board))));
	return A2(
		_elm_lang$core$Basics$max,
		A2(_elm_lang$core$Basics$max, rows, columns),
		A2(_elm_lang$core$Basics$max, diagsUp, diagsDown));
};
var _user$project$Connect4$indexOfCounter = function (column) {
	return A3(
		_elm_lang$core$List$foldr,
		_elm_lang$core$Basics$max,
		-1,
		A2(
			...
			F2(
				function (k, v) {
					return (!_elm_lang$core$Native_Utils.eq(v, 0)) ? k : -1;
				}),
			column));
};
var _user$project$Connect4$updateBoard = F4(
	function (x, y, p, board) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (k, col) {
					return _elm_lang$core$Native_Utils.eq(k, y) ? A2(
						_elm_lang$core$List$indexedMap,
						F2(
							function (k, v) {
								return (_elm_lang$core$Native_Utils.eq(k, x) && _elm_lang$core$Native_Utils.eq(
									x,
									_user$project$Connect4$indexOfCounter(col) + 1)) ? p : v;
							}),
						col) : col;
				}),
			board);
	});
var _user$project$Connect4$nextTurn = function (n) {
	return _elm_lang$core$Native_Utils.eq(n, 1) ? 2 : 1;
};
var _user$project$Connect4$parse_xyp = F2(
	function (xy, p) {
...
var _user$project$Connect4$Wmsg = F2(
	function (a, b) {
		return {key: a, val: b};
	});
var _user$project$Connect4$wsRespDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Connect4$Wmsg,
	A2(_elm_lang$core$Json_Decode$field, 'key', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'val', _elm_lang$core$Json_Decode$string));
var _user$project$Connect4$EndPh = {ctor: 'EndPh'};
var _user$project$Connect4$PlayComputerPh = {ctor: 'PlayComputerPh'};
var _user$project$Connect4$PlayOthersPh = {ctor: 'PlayOthersPh'};
						...
						switch (_p24) {
							...
							case 'move':
								...
								return (_elm_lang$core$Native_Utils.eq(updated, model.board) || (!_elm_lang$core$Native_Utils.eq(model.winner, 0))) ? model : _elm_lang$core$Native_Utils.update(
									...
									{
										board: updated,
										turn: _user$project$Connect4$nextTurn(t),
...
var _user$project$Connect4$QuitGame = {ctor: 'QuitGame'};
var _user$project$Connect4$SendName = {ctor: 'SendName'};
var _user$project$Connect4$InputName = function (a) {
	return {ctor: 'InputName', _0: a};
};
var _user$project$Connect4$FromServer = function (a) {
...
var _user$project$Connect4$Players = function (a) {
	return {ctor: 'Players', _0: a};
};
var _user$project$Connect4$Move = F2(
	function (a, b) {
		return {ctor: 'Move', _0: a, _1: b};
	});
var _user$project$Connect4$square = F3(
	function (y, x, p) {
		return A2(
			_elm_lang$html$Html$div,
			{
							...
							_1: {
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'background',
										_1: _elm_lang$core$Native_Utils.eq(p, 1) ? 'yellow' : (_elm_lang$core$Native_Utils.eq(p, 2) ? 'red' : 'black')
									},
									_1: {
										ctor: '::',
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_user$project$Connect4$Move, x, y)),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'});
	});
var _user$project$Connect4$column = F2(
	function (y, p) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			_elm_lang$core$List$reverse(
				A2(
					_elm_lang$core$List$indexedMap,
					_user$project$Connect4$square(y),
					p)));
	});
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Player mode'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: A2(
									_user$project$Connect4$radio,
									_user$project$Connect4$Players(1),
									'1 Player'),
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Connect4$radio,
										_user$project$Connect4$Players(2),
										'2 Players'),
									_1: {ctor: '[]'}
								}
							}),
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Connect 4 - Room'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Enter the room'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Connect4$InputName),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Connect4$SendName),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Connect4$Play),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$p,
							{ctor: '[]'},
							_elm_lang$core$Native_Utils.eq(model.winner, 0) ? {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Connect4$QuitGame),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								ctor: '::',
								_0: _elm_lang$html$Html$text('Computer is the winner'),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Connect4$Reset),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							_elm_lang$core$Native_Utils.eq(model.winner, 0) ? {
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Native_Utils.eq(model.turn, model.index) ? 'Your turn to play, ' : 'Wait for your turn, ',
										A2(_elm_lang$core$Basics_ops['++'], model.name, ' '))),
								_1: {
									ctor: '::',
									_0: A2(
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Native_Utils.eq(model.winner, model.index) ? 'You' : model.opponent,
										' won !!!')),
								_1: {
									ctor: '::',
									_0: A2(
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Connect4$boardStyle,
									_1: {ctor: '[]'}
								},
								A2(_elm_lang$core$List$indexedMap, _user$project$Connect4$column, model.board)),
							_1: {ctor: '[]'}
						}
					}
				});
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Game Ended'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
if (typeof _user$project$Connect4$main !== 'undefined') {
    _user$project$Connect4$main(Elm['Connect4'], 'Connect4', undefined);
}
